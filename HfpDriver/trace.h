...
//       a new guid, using tools\other\i386\guidgen.exe present in the DDK.
//

#define WPP_CHECK_FOR_NULL_STRING  //to prevent exceptions due to NULL strings

#define WPP_CONTROL_GUIDS \
    WPP_DEFINE_CONTROL_GUID(HfpDriverTraceGuid,(d8694f3b,26cd,48dd,bf36,1adb35192913), \
